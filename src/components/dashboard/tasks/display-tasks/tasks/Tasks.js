...
export const Tasks = () => {
    ...
    return (_jsxs(TasksWrapper, { children: [confirmDelete.show && _jsx(ConfirmDeleteModal, { actionFunction: taskDeleteHandler, value: confirmDelete, showModal: setConfirmDelete }), displayErrorModal && _jsx(TasksErrorModal, { displayErrorModal: displayErrorModal, setDisplayErrorModal: setDisplayErrorModal }), showModal && _jsx(TaskWarnigModal, { toggleModal: setShowModal }), _jsxs("div", { className: "cardsList", children: [_jsx("div", { className: "timeCard", children: _jsx("p", { children: "Time" }) }), fetchingLoading && _jsx(LoadingModal, { children: _jsx("img", { src: spinner }) }), taskHours.map((hour, index) => (_jsxs("div", { className: "tasksSameHour", id: "sameHour" + index, children: [_jsx(TasksTimeCard, { actualDay: sameDayTasks.filter((task) => task.taskHour === hour).length > 1 ? 'conflict' : actualDay, children: hour }, "timeCard" + index), _jsxs("div", { className: "tasksList", id: "taskList" + index, children: [sameDayTasks
                                        ...
                                        && _jsxs(_Fragment, { children: [_jsx("div", { className: "circle" }), _jsx("div", { className: "stroke" })] })] })] })))] })] }));
};
