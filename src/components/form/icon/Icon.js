...
export const Icon = (props) => {
    return (_jsx(IconWrapper, { iconIsInside: props.iconIsInside, children: _jsx("img", { alt: "icon", src: props.icon === 'userIcon' ? (props.hasError === true ? userErrorIcon : userIcon) : (props.hasError === true ? passworErrordIcon : passwordIcon), className: 'icon' }) }));
};
