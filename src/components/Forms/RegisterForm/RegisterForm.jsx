...
export const RegisterForm = () => {
    ...
    return (<Form page="signup">
            ...
            <InputWrapper>
                ...
                <Input type="date" name="birthDate" onChange={inputHandler} value={formState.birthDate.value} placeholder="MM/DD/YYYY" hasError={formState.birthDate.hasError}/>
            ...
            <InputWrapper>
                ...
                <Input type="password" name="confirmPassword" onChange={inputHandler} value={formState.confirmPassword.value} placeholder="Comfirm your password" hasError={formState.confirmPassword.hasError || formState.password.hasError}/>
