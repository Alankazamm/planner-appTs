System.register(["react", "./styles", "../../../../../../../../contexts/taskContext"], function (exports_1, context_1) {
    "use strict";
    var React, styles_1, react_1, taskContext_1, ActionsInputs;
    ...
    return {
        ...
        execute: function () {
            exports_1("ActionsInputs", ActionsInputs = () => {
                const { setTask, task } = react_1.useContext(taskContext_1.TasksContext);
