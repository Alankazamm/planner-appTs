...
export const createEvents = ({ description, dayOfWeek, taskHour }: { description: string, dayOfWeek: string, taskHour: string }) =>
    ({ setCreateEventResponse, setCreateIsLoading, setDisplayErrorModal }:
        { setCreateEventResponse: any, setCreateIsLoading: any, setDisplayErrorModal: any }) => {
