...
exports.TasksButton = exports.TasksButtonsContainer = void 0;
const styled_components_1 = __importDefault(require("styled-components"));
//container
exports.TasksButtonsContainer = styled_components_1.default.div `
  display: flex;
    flex-direction: row;
...
`;
//button
exports.TasksButton = styled_components_1.default.div `
