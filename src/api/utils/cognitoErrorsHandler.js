System.register([], function (exports_1, context_1) {
    "use strict";
    var CognitoErrorCodes, messageHandler;
    ...
    return {
        ...
        execute: function () {
            ...
            })(CognitoErrorCodes || (CognitoErrorCodes = {}));
            exports_1("CognitoErrorCodes", CognitoErrorCodes);
            exports_1("messageHandler", messageHandler = (error) => {
                if (error.message) {
