...
export const LoginForm = () => {
	...
	return (
		<Form
			page="login"
			hasError={formState.user.hasError || formState.loginPassword.hasError}
		>
			<h2>Login</h2>
			<LoginInputWrapper>
				<div>
					...
					/>
					{errorUser && (
						<TooltipError page="login">{formState.user.error}</TooltipError>
					)}
				</div>
				...
				<Icon
					icon="userIcon"
					hasError={errorUser}
					iconIsInside={iconIsInside.user}
				/>
			</LoginInputWrapper>
			<LoginInputWrapper>
				<div>
				...
				<Icon
					...
					iconIsInside={iconIsInside.password}
				/>
			</LoginInputWrapper>
